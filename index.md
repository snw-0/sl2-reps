...
For more information, please refer to [the package manual]({{site.data.package.doc-html}}). The manual is also available as a [PDF file]({{site.data.package.doc-pdf}}).
